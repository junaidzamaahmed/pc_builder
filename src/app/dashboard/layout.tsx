        ...
        <div className="flex h-full max-h-screen flex-col gap-2">
          <div className="flex-1 overflow-auto py-2">
            <nav className="grid items-start px-4 text-sm font-medium">
              ...
              <Link
                className={`${
                  pathname == "/dashboard/orders" && "bg-gray-100"
                } flex items-center gap-3 rounded-lg px-3 py-2 text-gray-900  transition-all hover:text-gray-900 dark:bg-gray-800 dark:text-gray-50 dark:hover:text-gray-50`}
              ...
              <Link
                className={`${
                  pathname == "/dashboard/products" && "bg-gray-100"
                } flex items-center gap-3 rounded-lg px-3 py-2 text-gray-900  transition-all hover:text-gray-900 dark:bg-gray-800 dark:text-gray-50 dark:hover:text-gray-50`}
              ...
              <Link
                className={`${
                  pathname == "/dashboard/brands" && "bg-gray-100"
                } flex items-center gap-3 rounded-lg px-3 py-2 text-gray-900  transition-all hover:text-gray-900 dark:bg-gray-800 dark:text-gray-50 dark:hover:text-gray-50`}
              ...
              <Link
                className={`${
                  pathname == "/dashboard/analytics" && "bg-gray-100"
                } flex items-center gap-3 rounded-lg px-3 py-2 text-gray-900  transition-all hover:text-gray-900 dark:bg-gray-800 dark:text-gray-50 dark:hover:text-gray-50`}
